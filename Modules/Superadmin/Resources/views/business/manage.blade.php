                        ...
                        <div class="row">
                               ...
                               @foreach ($business_locations as $location)
                                ...
                                {!! Form::label('whatsapp_phone_no', __('superadmin::lang.whatsapp_phone_no'), ['class' =>
                                        ...
                                        =>
                                        'whatsapp_phone_no', 'required', 'placeholder' => __('superadmin::lang.whatsapp_phone_no')]) !!} 
                                        </div>
                                        </div>
                                <div class="col-sm-3">
                                    <label for=""></label>
                           ...
                           <div class="row">
                                <div class="col-md-4">
                                    <div class="checkbox-wrapper">
                                        ...
                                        !empty($manage_module_enable['same_order_no_daily_collection']) ? true : true, ['class' =>
                                ...
                                <div class="col-md-3">
                                    ...
                                    !empty($manage_module_enable['daily_shift_page']) ? true : true, ['class' =>
                                    'input-icheck-red
                                    ch_select']) !!}<label
                                ...
                                <div class="col-md-3">
                                    ...
                                    !empty($manage_module_enable['daily_cash_tab']) ? true : true, ['class' =>
                                    'input-icheck-red
                                    ch_select']) !!}<label
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    !empty($manage_module_enable['daily_credit_sales']) ? true : true, ['class' =>
                                    'input-icheck-red
                                    ch_select']) !!}<label
                                ...
                                <div class="col-md-3">
                                    ...
                                    !empty($manage_module_enable['daily_cards']) ? true : true, ['class' =>
                                    'input-icheck-red
                                    ch_select']) !!}<label
                                ...
                                <div class="col-md-3">
                                    ...
                                    !empty($manage_module_enable['daily_shortage_excess']) ? true : true, ['class' =>
                                    'input-icheck-red
                                    ch_select']) !!}<label
                                ...
                                <div class="col-md-3">
                                    ...
                                    !empty($manage_module_enable['daily_cheques']) ? true : true, ['class' =>
                                    'input-icheck-red
                                    ch_select']) !!}<label
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    !empty($manage_module_enable['collection_summary']) ? true : true, ['class' =>
                                    'input-icheck-red
                                    ch_select']) !!}<label
                                ...
                                <div class="col-md-3">
                                    ...
                                    !empty($manage_module_enable['daily_collections_settings']) ? true : true, ['class' =>
                                    'input-icheck-red
                                    ch_select']) !!}<label
                                ...
                                <div class="col-md-3">
                                    ...
                                    !empty($manage_module_enable['daily_cash_status']) ? true : true, ['class' =>
                                    'input-icheck-red
                                    ch_select']) !!}<label
                                ...
                                <div class="col-md-3">
                                    ...
                                    !empty($manage_module_enable['daily_shift']) ? true : true, ['class' =>
                                    'input-icheck-red
                                    ch_select']) !!}<label
                                ...
                                <div class="col-sm-3">
                                    <div class="checkbox">
                                        <label class="flex-label" class="flex-label">
                                           {!! Form::checkbox('petro_settlement', 1, 
                                                (isset($manage_module_enable['petro_settlement']) ? !empty($manage_module_enable['petro_settlement']) : true), 
                                                ['class' => 'input-icheck-red ch_select', 'id'=>'petro_settlement']
                                            ); !!}
                                            {{__('petro::lang.petro_settlement')}}
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="card text-left bg-success"  style="border: 1px solid #D9D8D8; margin-bottom: 30px;">
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    {!! Form::checkbox('settlement_sw_module', 1, !empty($manage_module_enable['settlement_sw_module']) ? true :
                                    false, ['class' => 'input-icheck-red ch_select'])
                                    !!}
                                </div>
                                <div class="col-md-1">
