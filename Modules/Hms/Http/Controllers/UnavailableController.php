        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($unavailables)
                ...
                ->addColumn('action', function ($row) {
                    $html = '<a type="button" class="btn btn-primary btn-xs btn-modal-unavailable" 
                        href="' . action([\Modules\Hms\Http\Controllers\UnavailableController::class, 'edit'], ['unavailable' => $row->id]) . '" 
                        id="edit_unavailable_modal">
                        <i class="fa fa-edit"></i> ' . __('hms::lang.edit_unavailable') . '</a>';
                    
                    $html .= ' <a type="button" class="btn btn-danger btn-xs delete_unavailable_confirmation" 
                        href="' . route('delete_unavailable', $row->id) . '">
