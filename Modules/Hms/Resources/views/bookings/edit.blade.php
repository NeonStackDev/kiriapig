@extends('layouts.app')
@section('title', __('hms::lang.edit_booking'))
@section('content')
       ...
       <div class="col-md-8">
        <div class="box box-solid">
            <div class="box-header">
                <h3 class="box-title"> @lang('hms::lang.edit_booking')</h3>
            </div>
            <div class="box-body">
                {!! Form::open([
                    'url' => action([\Modules\Hms\Http\Controllers\HmsBookingController::class, 'update'],[$transaction->id]),
                    'method' => 'put',
                    'id' => 'edit_booking',
                    'files' => true 
                ]) !!}

                <input type="hidden" name="total_booking_amount" id="total_booking_amount">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('status', $status, $transaction->status, [
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('arrival_date', @format_date($transaction->hms_booking_arrival_date_time), [
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('arrival_time', @format_time($transaction->hms_booking_arrival_date_time), [
                 ...
                 <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('departure_date', @format_date($transaction->hms_booking_departure_date_time), [
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('departure_time', @format_time($transaction->hms_booking_departure_date_time), [ 
                            'class' => 'form-control time_picker',
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('mobile_no', 'Mobile No with Country code (without zeros & + mark)') !!}
                        {!! Form::text('mobile_no', isset($transaction->mobile_no) ? $transaction->mobile_no : null, [
                            'class' => 'form-control',
                            'placeholder' => 'Enter comma separated mobile numbers',
                            'pattern' => '^([1-9][0-9]{4,14})(,([1-9][0-9]{4,14}))*$',
                            'title' => 'Enter valid mobile numbers separated by commas',
                        ]) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('whatsapp_no', 'WhatsApp No with Country code (without zeros & + mark)') !!}
                        {!! Form::text('whatsapp_no', isset($transaction->whatsapp_no) ? $transaction->whatsapp_no : null, [
                            'class' => 'form-control',
                            'placeholder' => 'Enter comma separated WhatsApp numbers',
                            'pattern' => '^([1-9][0-9]{4,14})(,([1-9][0-9]{4,14}))*$',
                            'title' => 'Enter valid WhatsApp numbers separated by commas',
                        ]) !!}
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-8 booking_add_room">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($booking_rooms as $index => $room)
                                <tr>
                                        <input type="hidden" value="{{ $room->total_price }}" name="rooms[{{ $index }}][total_price]">
                                        <input type="hidden" value="{{ $room->price }}" name="rooms[{{ $index }}][price]">
                                        <input type="hidden" value="{{ $room->hms_room_type_id }}" name="rooms[{{ $index   }}][type_id]">
                                        <input type="hidden" class="room-id-input" value="{{ $room->hms_room_id }}" name="rooms[{{ $index }}][room_id]">
                                        <input type="hidden" value="{{ $room->adults }}" name="rooms[{{ $index }}][no_of_adult]">
                                        <input type="hidden" value="{{ $room->childrens }}" name="rooms[{{ $index }}][no_of_child]">
                                    <td>
                                        {{ $room->type }}
                                    ...
                                    <td> 
                                        ...
                                        <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm tw-m-0.5 edit"><i class="fa-solid fa-edit"></i></i></button> 
                                    </td> 
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white add-room btn btn-primary">  @lang('messages.add') @lang('hms::lang.rooms')</button>
                </div>
                <div class="col-md-4">
                    <table class="table table-bordered">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                     <input type="checkbox" name="extras[{{ $extra->id }}][id]" class="extra" value="{{$extra->id}}" data-value="{{$extra->price_per}}" data-price="{{$extra->price}}" @if (in_array($extra->id, $extras_id))
                                         checked
                                     @endif>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                           <strong class="display_currency room_price" data-currency_symbol="true">0.00</strong>
                        </div>
                    </div>
                        <div class="row">
                        <div class="col-xs-6">
                        ...
                        <div class="col-xs-6 text-right">
                            ...
                            <strong class="display_currency extra_price" data-currency_symbol="true">0.00</strong>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                        ...
                        <div class="col-xs-6 text-right">
                            <strong class="display_currency total_discount_show" data-currency_symbol="true">0.00</strong>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                            <strong class="display_currency total" data-currency_symbol="true">0.00</strong>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('coupon_code', $transaction->coupon_code, [
                                    'class' => 'form-control coupon_code',
                                    'placeholder' => __('hms::lang.coupon_code'),
                                    'disabled' => (empty($transaction->hms_coupon_id) && $transaction->discount_amount > 0) ? 'disabled' : null,
                                ]) !!}
                                <div class="coupon-box" style="display:none"></div>
                            </div>
                            <a class="tw-dw-btn tw-dw-btn-success tw-text-white tw-dw-btn-sm apply_coupon">@lang('hms::lang.apply_coupon')</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-solid">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="final_total_div col-md-2">
                            {!! Form::label("amount_total" ,__('sale.amount') . ':') !!}
                            {!! Form::text('', null, [
                                'class' => 'form-control',
    ...
    <button type="submit" name="submit_action" value="save" id="submit_action" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-lg btn btn-primary">@lang('messages.save')</button>
    </div>
       {!! Form::close() !!}
           {{-- model  --}}
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    ...
    <script>
        $(document).ready(function() {
            var current_index = parseFloat("{{ count($booking_rooms) }}") + 1;
            var row = null;
            var coupon_id = null;
            ...
            async function getCouponDiscount(price, type_id) {
                var discount = 0;
                    ...
                    if (result.status === 1) {
                        // Case 1: If room_type_id is a JSON array (multiple types)
                        if (result.coupon.hms_room_type_id == 0 || result.coupon.room_type_id) {
                            // Check if the coupon has a list of valid room types (Case 1)
                            let validRoomTypes = result.coupon.room_type_id ? JSON.parse(result.coupon.room_type_id) : [];
                            console.log(validRoomTypes);
                            console.log(type_id);
                            // Case 1: If selected room type is in the list of valid room types
                            // Convert type_id to string for comparison, if needed
                            if (validRoomTypes.includes(type_id.toString())) {
                                ...
                                discount = 0;  // Coupon does not apply
                            }
                        }
                        // Case 2: If room_type_id is a specific value (single room type)
                        else if (result.coupon.hms_room_type_id == type_id) {
                            if (result.coupon.discount_type == 'fixed') {
                                discount = result.coupon.discount;
                            } else {
                                discount = (result.coupon.discount * price) / 100;
            ...
            async function calculateAllPrice() {
                    ...
                    await Promise.all(
                        $('.booking_add_room table tbody tr').map(async function() {
                            ...
                            if($('#coupon_code').val() != ''){
                                discount = await getCouponDiscount(calculateDays() * price, type_id);
                    ...
                    $('#total_booking_amount').val(total);
                    $('#final_total_div').val(total);
                    ...
                    $('.input_number').val(__currency_trans_from_en(total.toFixed(2) , true));
            }
            ...
            $(document).on('change', '.payment_types_dropdown', function() {
                ...
                var accounting_module_dropdown = $('#change_return_account');
                if (payment_type && payment_type != 'advance') {
                var default_account = default_accounts && default_accounts[payment_type]['account'] ?
                    default_accounts[payment_type]['account'] : '';
                var account_dropdown = payment_row.find('select#account_' + row_index);

                // Load accounting modules based on payment type
                if (accounting_module_dropdown.length) {
                    accounting_module_dropdown.prop('disabled', false);
                    ...
                    $.ajax({
                        ...
                        contentType: 'html',
                        success: function(result) {
                            accounting_module_dropdown.empty().append(result);
                            accounting_module_dropdown.attr('required', true);
                            accounting_module_dropdown.val(accounting_module_dropdown.find('option:first').val());
                        }
                    });
                }
            ...
            function calculate_balance_due() {
                var total_payable = __read_number($('#total_booking_amount'));
                var total_paying = 0;
                    $('.payment-amount')
                    .each(function() {
