...
//dd($closedShifts );
        ...
        return view('petro::daily_collection.partials.create_daily_cards')->with(compact('dailyShiftOperators','card_types','customers','locations', 'pump_operators', 'collection_form_no','default_location'));
    }
