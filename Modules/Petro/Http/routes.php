...
Route::group(['middleware' => ['web', 'auth', 'language', 'SetSessionData', 'DayEnd', 'tenant.context'], 'prefix' => 'petro', 'namespace' => 'Modules\Petro\Http\Controllers'], function () {
    ...
    // Settlement SW routes
// Route::get('/settlement-sw', 'SettlementSWController@index')->name('settlement_sw.index');
// Route::get('/settlement-sw/create', 'SettlementSWController@create')->name('settlement_sw.create');
// Route::post('/settlement-sw/store', 'SettlementSWController@store')->name('settlement_sw.store');
// Route::get('/settlement-sw/show/{id}', 'SettlementSWController@show')->name('settlement_sw.show');
// Route::get('/settlement-sw/edit/{id}', 'SettlementSWController@edit')->name('settlement_sw.edit');
// Route::post('/settlement-sw/update/{id}', 'SettlementSWController@update')->name('settlement_sw.update');
// Route::delete('/settlement-sw/delete/{id}', 'SettlementSWController@destroy')->name('settlement_sw.destroy');
...
Route::resource('/whatsapp-templates', 'PetroWhatsAppTemplateController');
    ...
    Route::get('/pump-operators/unblock-pumper-login-attempt/{id}', 'PumpOperatorController@unblockPumperLoginAttempt')->name('petro.unblockPumperLoginAttempt');
    Route::get('/pump-operators/unblock-pumper-login-attempts', 'PumpOperatorController@blockedPumperLoginAttempt')->name('petro.blockedPumperLoginAttempt');
...
Route::group(['middleware' => ['web', 'auth', 'language', 'SetSessionData', 'DayEnd', 'tenant.context'], 'namespace' => 'Modules\Petro\Http\Controllers'], function () {
    Route::get('get-settings', 'DailyCollectionController@settings')->name('petro.getSettings');
