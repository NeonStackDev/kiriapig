...
if (isset($merged_results_prev[$category_id])) {
  // If the category already exists, add the quantities and sales
  $merged_results_prev[$category_id]['total_quantity'] += (int) $item['total_quantity'];
  $merged_results_prev[$category_id]['total_sales'] += (int) $item['total_sales'];
} else {
  // If the category doesn't exist, initialize it
  $merged_results_prev[$category_id] = [
      'category_id' => $item['category_id'],
...
foreach ($total_issues_previous as $item) {
    ...
    $merged_results_prev_issue[$category_id]['total_quantity'] += (int)$item['total_quantity'];
    $merged_results_prev_issue[$category_id]['total_sales'] += (int) $item['total_sales'];
}
