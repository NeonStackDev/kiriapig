                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <button type="submit" name="submit_type" id="f22_print" value="print"
                            class="btn btn-primary btn-sm" style="padding-top: 7px;padding-bottom: 7px;">@lang('mpcs::lang.print')</button>
                        <button type="submit" name="submit_type" id="f22_save_and_print" value="save_and_print"
                            class="btn btn-primary btn-sm" style="margin-left: 20px; background-color: #ff5733; border: none;padding-top: 8px;padding-bottom: 8px;">@lang('mpcs::lang.save_and_print')</button>
                    </div>
                    <div class="col-md-3" style="padding-left:0px">
                        <div class="form-group">
                            {!! Form::text('search', null, ['class' => 'form-control', 'id' => 'form_22_table_search_input', 'placeholder' => 'Search...']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="text-center pull-left">
                            <h5 style="font-weight: bold;" class="text-red">
                                @lang('mpcs::lang.f22_form_no') : <span id="form_no1">{{ $F22_from_no }}</span></h5>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
                        ...
                        <table class="table table-bordered table-striped" id="form_22_table" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th id="mpcs-form-current-stock">@lang('mpcs::lang.current_stock')</th>
                                    <th id="mpcs-form-stock-count">@lang('mpcs::lang.stock_count')</th>
                                    <th id="mpcs-form-unit-purchase-price">@lang('mpcs::lang.unit_purchase_price')</th>
                                    <th id="mpcs-form-total-purchase-price">@lang('mpcs::lang.total_purchase_price')</th>
                                    <th id="mpcs-form-unit-sale-price">@lang('mpcs::lang.unit_sale_price')</th>
                                    <th id="mpcs-form-total-sale-price">@lang('mpcs::lang.total_sale_price')</th>
