...
@section('javascript')
            ...
            form_9ccredit_table = $('#form_9ccredit_table').DataTable({
                ...
                columns: [
                    ...
                    // },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data == null || data === '') return '';
                            let value = (row.goods_rs || 0) + '.' + (row.goods_cent || '00');
                            return parseFloat(value).toFixed({{ $currency_precision }});
                        }
                    },
                    // {
                    ...
                    // },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data == null || data === '') return '';
                            let value = (row.loading_rs || 0) + '.' + (row.loading_cents || '00');
                            return parseFloat(value).toFixed({{ $currency_precision }});
                        }
                    },
                    // {
                    ...
                    // },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data == null || data === '') return '';
                            let value = (row.empty_rs || 0) + '.' + (row.empty_cent || '00');
                            return parseFloat(value).toFixed({{ $currency_precision }});
                        }
                    },
                    // {
                    ...
                    // },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data == null || data === '') return '';
                            let value = (row.transport_rs || 0) + '.' + (row.transport_cent || '00');
                            return parseFloat(value).toFixed({{ $currency_precision }});
                        }
                    },
                    // {
                    ...
                    // },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data == null || data === '') return '';
                            let value = (row.other_rs || 0) + '.' + (row.other_cent || '00');
                            return parseFloat(value).toFixed({{ $currency_precision }});
                        }
                    },
                    // {
    ...
    let custom_message = response.custom_message ?? '';
    $('#custom_message').html(custom_message);
}
