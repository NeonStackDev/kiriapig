<div class="modal-dialog" role="document" style="width: 50%;">
    <div class="modal-content">
        {!! Form::open(['url' => action('\Modules\MPCS\Http\Controllers\Form9CSettingsController@store'), 'method' => 'post', 'id' => 'add_9c_form_settings' ]) !!}

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">@lang( 'mpcs::lang.add_form_9_c_settings' )</h4>
        </div>
        ...
        <div class="modal-body">
            <div class="col-md-12"><br />
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>@lang('mpcs::lang.total_previous_page') <span class="required" aria-required="true">*</span></label>
