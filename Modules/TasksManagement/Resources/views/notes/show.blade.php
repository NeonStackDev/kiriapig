...
<div class="modal-dialog" role="document" style="width: 60%;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <b>@lang('tasksmanagement::lang.note_status'):</b> {{$note->status_name}}
                </div>
                <div class="col-sm-3">
                    <b>@lang('tasksmanagement::lang.note_status_color'):</b> <div style="float: right;height: 25px; width: 25px; background:{{$note->status_color}}"></div>
                </div>
            </div>
            <br>
            <br>
