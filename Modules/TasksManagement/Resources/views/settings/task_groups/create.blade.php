<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\TasksManagement\Http\Controllers\TaskGroupController@store'), 'method' => 'post', 'id' => 'account_type_form' ])
    !!}
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
          aria-hidden="true">&times;</span></button>
      <h4 class="modal-title">@lang( 'tasksmanagement::lang.add_task_group' )</h4>
    </div>

    <div class="modal-body">
      <div class="form-group">
        {!! Form::label('name', __( 'tasksmanagement::lang.name' )) !!}
        {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'tasksmanagement::lang.name' ), 'id' => 'task_group_name']);
        !!}
      </div>
    ...
    <div class="modal-footer">
      <button type="submit" class="btn btn-primary" id="save_task_group_btn">@lang( 'messages.save' )</button>
