<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\TasksManagement\Http\Controllers\StatusController@store'), 'method' => 'post', 'id' => 'account_type_form' ])
    !!}
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
          aria-hidden="true">&times;</span></button>
      <h4 class="modal-title">@lang( 'tasksmanagement::lang.add_status' )</h4>
    </div>

    <div class="modal-body">
      <div class="form-group">
        {!! Form::label('Status name', __( 'tasksmanagement::lang.name' )) !!}
      ...
      <div class="form-group">
        ...
        !!}
        {!! Form::hidden('color', "#3490dc", ['id' => 'color']) !!}
      </div>
      <div class="form-group">
        {!! Form::label('Default', '') !!}
        {!! Form::select('default', array_combine([0,1], ['No', 'Yes']), $defaultExit ? 0: 1, ['class' => 'form-control', 'required',  'id' => 'status_default', 'readonly' => $defaultExit]);
        !!}
      </div>
