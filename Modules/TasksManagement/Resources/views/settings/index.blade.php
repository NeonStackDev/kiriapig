...
<section class="content">
            ...
            <div class="settlement_tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li class="@if(session('status.tab') =='task') active @endif">
                        <a href="#tasks_settings" class="tasks_settings" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i>
                            <strong>@lang('tasksmanagement::lang.tasks_group')</strong>
                        </a>
                    </li>
                    ...
                    <li class="@if(session('status.tab') =='status') active @endif">
                        <a href="#status" class="priorities_settings" data-toggle="tab">
                            <i class="fa fa-file-text-o"></i>
                            <strong>@lang('tasksmanagement::lang.status')</strong>
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane @if(session('status.tab') =='status') active @endif" id="status">
                        @include('tasksmanagement::settings.partials.status')
                    </div>
    ...
    <div class="modal fade status_model" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
    </div>
</section>
<!-- /.content -->
...
<script>
    ...
    status_table = $('#status_table').DataTable({
        processing: true,
        serverSide: false,
        ajax: "{{action('\Modules\TasksManagement\Http\Controllers\StatusController@index')}}",
        columnDefs:[{
            "targets": 1,
            "orderable": false,
            "searchable": false
    ...
    $(document).on('click', 'button.status_delete', function(){
        swal({
            title: LANG.sure,
            icon: "warning",
            buttons: true,
