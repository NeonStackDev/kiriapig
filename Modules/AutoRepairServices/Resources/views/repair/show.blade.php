                ...
                <div class="box-body" style="display: none;">
                    <table class="table table-condensed bg-gray">
                        ...
                        <tr>
                            ...
                            <td><a href="{{action('\Modules\AutoRepairServices\Http\Controllers\RepairController@deleteMedia', $media->id)}}"" class="btn btn-danger btn-xs delete_media"><i class="fa fa-trash"></i></a></td>
                        </tr>
                        @empty
                        <tr>
