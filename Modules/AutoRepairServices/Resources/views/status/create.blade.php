...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\AutoRepairServices\Http\Controllers\RepairStatusController@store'), 'method' => 'post', 'id' => 'status_form']) !!}
    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-md-6">
                ...
                {!! Form::text('name', old('name', isset($is_default_status) && $is_default_status ? 'Completed' : null), ['class' => 'form-control', 'required', 'placeholder' => __( 'repair::lang.status_name' ), 'readonly' => (isset($is_default_status) && $is_default_status) ]); !!}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mt-15">
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                        <input type="checkbox" name="is_completed_status" value="1" @disabled(!(isset($is_default_status) && $is_default_status)) id="is_completed_status"
                     {{ old('is_completed_status', isset($is_default_status) && $is_default_status ? 'checked' : '') }}>
                        </label>
                    </div>
                </div>
            </div>
