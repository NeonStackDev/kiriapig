...
Route::middleware(['App\Http\Middleware\AutoLogoutMiddleware', 'IsInstalled', 'auth:customer,web', 'SetSessionData', 'DayEnd', 'language', 'timezone', 'bootstrap','isVerified'])->group(function () {
    ...
    // User Groups Routes
    Route::get('/user-groups', 'UserGroupController@index')->name('user_groups.index');
    Route::get('/user-groups/create', 'UserGroupController@create')->name('user_groups.create');
    Route::post('/user-groups', 'UserGroupController@store')->name('user_groups.store');
    Route::get('/user-groups/{id}/edit', 'UserGroupController@edit')->name('user_groups.edit');
    Route::put('/user-groups/{id}', 'UserGroupController@update')->name('user_groups.update');
    Route::delete('/user-groups/{id}', 'UserGroupController@destroy')->name('user_groups.destroy');
    ...
    Route::get('/product/product-bind-supplier-get', 'SupplierMappingController@indexSupplier');
  ...
  Route::get('/purchases/get_suppliers/{id}', 'PurchaseController@getSuppliertId');
    ...
    Route::get('/api/get-liability-accounts', [TransactionPaymentController::class, 'getLiabilityAccounts']);
