...
Route::middleware(['web'])->group(function () {
    ...
    Route::get('/check', function () {
        return session('param'); // Should return "hello"
    });
});
 // Pages
...
// 
    ...
    Route::get('/customer/search', 'ContactController@search');
    ...
    Route::get('edit/{id}', [StockConversionController::class, 'edit'])->name('stockconversion.edit');
        ...
        Route::get('delete/{id}', [StockConversionController::class, 'delete'])->name('stockconversion.delete');
...
//sakhi
    ...
    Route::group(['prefix' => 'accounting-module'], function () {
        ...
        Route::post('/edit-cheque-ob/{id}', 'AccountController@updateChequeOb')->name('accounts.edit.cheque.ob');
...
Route::group(['middleware' => ['web'], 'prefix' => 'mpcs', 'namespace' => 'Modules\MPCS\Http\Controllers'], function () {
    ...
    Route::get('/get-form-9c-settings', [\Modules\MPCS\Http\Controllers\Form9CSettingsController::class, 'index'])->name('mpcs.forms.form_9c');
    Route::get('/get-form-9c-settings', [\Modules\MPCS\Http\Controllers\Form9CSettingsController::class, 'create'])->name('mpcs.forms.partials.create_9c_form_settings');
    Route::post('/store-form-9c-settings', [\Modules\MPCS\Http\Controllers\Form9CSettingsController::class, 'store'])->name('mpcs.forms.form_9c');
    Route::get('/edit-form-settings-9c/{id}', [\Modules\MPCS\Http\Controllers\Form9CSettingsController::class, 'edit'])->name('mpcs.forms.partials.edit_9c_form_settings');
    Route::post('/update-form-settings-9c/{id}', [\Modules\MPCS\Http\Controllers\Form9CSettingsController::class, 'update'])->name('mpcs.forms.form_9c');
});
