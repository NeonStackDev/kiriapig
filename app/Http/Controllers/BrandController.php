...
class BrandController extends Controller
{
    ...
    public function getBrandsByVehicle($vehicleId)
    {
        // Récupérer les brand_ids liés à ce vehicle dans les jobsheets
        $brandIds = JobSheet::where('vehicle_id', $vehicleId)
            ->distinct()
            ->pluck('brand_id');
