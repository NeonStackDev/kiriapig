...
// dd('store');
...

    {
        ...
        try {
            ...
            $transaction_data = $request->only(['is_vat', 'ref_no','shift_number',
                'transaction_date', 'location_id', 'final_total', 'expense_for', 'fleet_id', 'additional_notes', 'expense_category_id', 'tax_id', 'contact_id']);
            $transaction_data['transaction_date'] = $transaction_data['transaction_date'] ?? $request->expense_transaction_date;
            $has_reviewed = $this->transactionUtil->hasReviewed($transaction_data['transaction_date']);
...
// dd($transaction_data['controller_account']);
    ...
    // dd($ref_count);
                        ...
                        $inputs['shift_number'] = $transaction_data['shift_number'];
                        $tp = TransactionPayment::create($inputs);
