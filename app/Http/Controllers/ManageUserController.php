  ...
  */              
    ...
    public function create()
    {
        ...
        return view('manage_user.create')
            ->with(compact('roles', 'username_ext', 'contacts', 'locations', 'store', 'member_module_permission', 'gramasevaka_areas', 'bala_mandalaya_areas', 'member_groups', 'employees', 'property_module_permission', 'user_groups'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $user_details = $request->only([
                ...
                'custom_field_3', 'custom_field_4', 'id_proof_name', 'id_proof_number', 'cmmsn_percent', 'max_sales_discount_percent', 'employee_id', 'user_group_id', 'is_property_user'
            ]);
    ...
    public function edit($id)
    {
       ...
       $roles = $this->getRolesArray($business_id);
        ...
        return view('manage_user.edit')
            ->with(compact('store', 'roles', 'user', 'contact_access', 'contacts', 'is_checked_checkbox', 'locations', 'permitted_locations', 'member_module_permission', 'gramasevaka_areas', 'bala_mandalaya_areas', 'member_groups', 'employees', 'property_module_permission', 'user_groups'));
    }
