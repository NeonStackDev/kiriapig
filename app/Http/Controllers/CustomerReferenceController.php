...
class CustomerReferenceController extends Controller
{
    ...
    public function create()
    {
        ...
        $vehicals=new_vehicle::pluck('vehicle_no', 'id');
        return view('customer_reference.create')->with(compact('contacts', 'help_explanations', 'quick_add', 'vehicals'));
    }
    ...
    public function getCustomerReferenceIdInValue($id)
    {
        $refs = CustomerReference::where('contact_id', $id)->select('id', 'reference')->get();
