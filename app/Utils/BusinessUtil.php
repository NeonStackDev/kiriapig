...
class BusinessUtil extends Util
{
    ...
    public function addLocation($business_id, $location_details, $invoice_scheme_id = null, $invoice_layout_id = null)
    {
        ...
        $location = BusinessLocation::create([
            ...
            'latitude' => $location_details['latitude'] ?? null,
            'longitude' => $location_details['longitude'] ?? null,
            'timezone' => $location_details['timezone'] ?? null,
            'location_access_type' => $location_details['location_access_type'] ?? null,
        ...
        $store = Store::create($storeDetails);
        
       $default_store = Business::find($business_id);
       $default_store->default_store=$store->id;
       $default_store->save();
