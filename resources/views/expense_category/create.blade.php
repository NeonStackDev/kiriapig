  ...
  <div class="modal-content">
    ...
    @if($expcode == "0")
      <div class="modal-header">
        ...
        <h4 class="modal-title">@lang( 'expense.add_expense_category_error' )</h4>
      </div>
      <div class="modal-body">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <p style="color: red">Please add an Expense Category Code first. click here <a href="{{ url('/expense-categories-code') }}" target="_blank" class="" >
                  Add
                </a></p>
            </div>
          </div>
    ...
    @else
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          {!! Form::text('code', $expcode, ['class' => 'form-control', 'placeholder' => __( 'expense.category_code' ),'readonly']); !!}
        </div>
        @if($account_access)
        <div class="form-group">
        ...
        <div class="form-group">
            <label>
                {!! Form::checkbox('vat_claimed', 1, false, ['class' => 'input-icheck', 'id' => 'vat_claimed']); !!} <strong>@lang('product.vat_input_claimed')</strong>
            </label>
          </div>
        ...
        <div class="form-group">
          <label for="is_employee">
            {!! Form::checkbox('is_employee', 1, false, ['class' => 'input-icheck', 'id' => 'is_employee']) !!} @lang('expense.is_employee')
          </label>
        </div>
        <div class="form-group hide employee_list">
          {!! Form::label('employee_id', __('expense.employee_list') . ':*') !!}
          {!! Form::select('employee_id', $employees, null, ['class' => 'form-control select2', 'placeholder'
          =>
          __('lang_v1.please_select'), 'style' => 'width: 100%']) !!}
        </div>
        <!-- Added By Ram End -->
