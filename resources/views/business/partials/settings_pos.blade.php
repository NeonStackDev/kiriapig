        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox"> 
                    <br>
                    <label>
                        {!! Form::hidden('pos_settings[show_purchase_price]', 0) !!}
                        {!! Form::checkbox('pos_settings[show_purchase_price]', 1,
                        empty($pos_settings['show_purchase_price']) ? 0 : 1 ,
                        [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.Show_Purchase_Price' ) }}
                    </label>
                </div>
            </div>
        </div>
