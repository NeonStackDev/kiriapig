...
<div class="payment_details_div_refund hide" data-type="bank_transfer" >
	...
	<div class="col-md-6">
        ...
        {!! Form::text( "transfer_date", $selected_cheque && $selected_cheque->transfer_date ? $selected_cheque->transfer_date : null, ['class' => 'form-control transfer_date', 'placeholder' => __('lang_v1.transfer_date')]); !!}
		</div>
	</div>
</div>
...
<div class="cheque_return_charges_div hide" data-type="cheque_return" >
	<div class="col-md-6">
		<div class="form-group">
			...
			{!! Form::text("cheque_return_charges", $selected_cheque && $selected_cheque->cheque_return_charges ? $selected_cheque->cheque_return_charges : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.cheque_return_charges')]); !!}
		</div>
	</div>
</div>