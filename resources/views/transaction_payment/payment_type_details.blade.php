...
<div class="payment_details_div @if( strtolower($payment_line->method) !== 'cheque' && strtolower($payment_line->method) !== 'bank_transfer' && strtolower($payment_line->method) !== 'bank'  && strtolower($payment_line->method) !== 'direct_bank_deposit' ) {{ 'hide' }} @endif add_payment_bank_details" data-type="cheque" >
	<div class="col-md-6">
		<div class="form-group">
			{!! Form::label("cheque_number",__('lang_v1.cheque_no')) !!}
			{!! Form::text("cheque_number", $payment_line->cheque_number, ['class' => 'form-control', 'placeholder' => __('lang_v1.cheque_no'),'disabled' => false, 'readOnly' => isset($is_transaction) && $is_transaction == true ? 'readonly' : null]); !!}
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group bankName">
			{!! Form::label("bank_name",'Bank Name') !!}
			{!! Form::text("bank_name", $payment_line->bank_name, ['class' => 'form-control', 'placeholder' => 'Bank Name','disabled' => false, 'readOnly' => isset($is_transaction) && $is_transaction == true ? 'readonly' : null]); !!}
		</div>
	</div>
	<div class="col-md-12">
    <div class="form-group">
        {!! Form::label("cheque_date", __('lang_v1.cheque_date')) !!}
        {!! Form::text("cheque_date", $payment_line->cheque_date, [
            'class' => 'form-control cheque_date',
            'placeholder' => __('lang_v1.cheque_date'),
            'autocomplete' => 'off'
        ]) !!}
    </div>
</div>
