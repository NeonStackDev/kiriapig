<div class="modal-dialog" role="document">
  ...
  @php
    if($selected_cheque){
      $controller_action = action('TransactionPaymentController@updateChequeTransaction', [$account_transaction_id]); 
      $method = 'put';
    }else{
      $method = 'post';
    ...
    {!! Form::open(['url' => $controller_action, 'method' => $method,
      ...
      <div class="row payment_row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              __('lang_v1.cheque_return')], $selected_cheque && $selected_cheque->type ? $selected_cheque->type : null , ['class' => 'form-control input_number', 'required', 'placeholder' =>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text("amount", $selected_cheque && $selected_cheque->amount ? $selected_cheque->amount : null, ['class' => 'form-control input_number', 'data-rule-min-value' => 0,
              'data-msg-min-value' => __('lang_v1.negative_value_not_allowed'), 'required']);
              !!}
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text( "paid_on", $selected_cheque && $selected_cheque->paid_on ? $selected_cheque->paid_on : null, ['class' => 'form-control paid_on_date', 'placeholder' => __('lang_v1.paid_on') , 'id' => 'paid_on_date']); !!}
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::select("method", $payment_types, $selected_cheque && $selected_cheque->method ? $selected_cheque->method : null, ['class' => 'form-control select2
        ...
        <div class="col-md-4 cheque_return_charges_div hide">
          <div class="form-group">
            ...
            {!! Form::select('cheque_bank', $cheque_banks, $selected_cheque->cheque_bank ?? null, $attributes) !!}
        ...
        <div class="col-md-4 cheque_return_charges_div hide">
          <div class="form-group">
            ...
            {!! Form::select("cheque_number_return", $cheque_array, $selected_cheque && $selected_cheque->cheque_number ? $selected_cheque->cheque_number : null, ['class' => 'form-control select2
            cheque_number_return', 'required' => $selected_cheque == null, 'placeholder' => __('lang_v1.please_select')]); !!}
          </div>
