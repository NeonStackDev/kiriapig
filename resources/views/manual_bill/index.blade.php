                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="transaction_date_range_bill" name="transaction_date_range" class="form-control transaction_date_filter" placeholder="Select date or range">
                        ...
                        <tr><th>Qty</th><td><input type="number" id="qty" name="qty" class="form-control"></td></tr>
                        <tr><th>Unit Price</th><td><input type="number" id="unit_price" name="unit_price" step="0.01" class="form-control"></td></tr>
                        <tr><th>Total</th><td><input type="number" id="total" name="total" step="0.01" class="form-control"></td></tr>
        ...
        if (productId) {
            $.ajax({
                ...
                success: function(response) {
                   console.log("manual-bill",response);
                    $('#unit_price').val(response.unit_price);
                    calculateTotal(); // Recalculate total if qty is already filled
                }
            });
        }
    });
