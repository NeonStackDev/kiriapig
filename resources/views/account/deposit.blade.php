      ...
      <div class="row">
          ...
          <div class="form-group col-sm-4">
            ...
            <div class="input-group date" id='od_datetimepicker'>
              {!! Form::text('operation_date', now()->toDateTimeString(), ['class' => 'form-control', 'required','placeholder' => __(
              'messages.date' ) ]); !!}
...
<script type="text/javascript">
  ...
  $(document).ready( function(){
      ...
      console.log($('#od_datetimepicker').datetimepicker());
    ...
    // $('#operation_date').val(moment(new Date()))
  });
