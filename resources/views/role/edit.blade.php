...
@section('content')
    ...
    <section class="content pos-tab-container">
        @component('components.widget', ['class' => 'box-primary'])
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                ...
                                [ 'class' => 'input-icheck']); !!} {{ __( 'customer_payments.edit' ) }}
                            </label>
                        </div>
                    </div>   
                    <div class="col-md-12">
            ...
            @if(!empty($get_permissions['auto_services_and_repair_module']) && $get_permissions['auto_services_and_repair_module'])
            <div class="row check_group">
                <div class="col-md-1">
                    <h4><label>@lang( 'role.repair' )</label></h4>
                </div>
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'auto_services_and_repair_module.job_sheet.access', in_array('auto_services_and_repair_module.job_sheet.access',
                                $role_permissions),
                                [ 'class' => 'input-icheck']); !!} {{ __( 'role.auto_services_and_repair_module.job_sheet.access' ) }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'repair.auto_services_and_repair_module.job_sheet.edit', in_array('repair.auto_services_and_repair_module.job_sheet.edit',
                                $role_permissions),
                                [ 'class' => 'input-icheck']); !!} {{ __( 'role.repair.auto_services_and_repair_module.job_sheet.edit' ) }}
                            </label>
                        </div>
                    </div>
                </div>
