...
@else
    <ul class="custom-overflow sidebar-menu navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
                ...
                <div id="helpguide-menu" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @can('superadmin')
                            ...
                            <a class="collapse-item {{ $request->segment(1) == 'helpguide' && $request->segment(2) == '' ? 'active active-sub' : '' }}"
                                href="{{ action('\Modules\HelpGuide\Http\Controllers\Frontend\IndexController@index') }}"
                    ...
                    <div id="development-menu"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item {{ $request->segment(1) == 'development' && $request->segment(2) == 'settings' ? 'active' : '' }}"
                                href="{{ route('development.settings.index') }}">@lang('development::lang.settings')</a>
                            <a class="collapse-item {{ request()->routeIs('development.create') ? 'active' : '' }}"
                                href="{{ route('development.create') }}">@lang('development::lang.add_development')
                            </a>
                            <a class="collapse-item {{ request()->routeIs('list-development.index') ? 'active' : '' }}"
                                href="{{ route('list-development.index') }}">@lang('development::lang.list_development')
                            </a>
                        </div>
                    </div>
                </li>
                                    ...
                                    @if ($contact_supplier)
                                        @can('supplier.view')
                                            <a class="collapse-item {{ $request->input('type') == 'supplier' ? 'active' : '' }}"
                                                href="{{ action('ContactController@index', ['type' => 'supplier']) }}">@lang('report.supplier')</a>
                                            @endcan @endif @can('customer.view') @if ($contact_customer)
                                                {{-- @if (!$property_module) --}}
                                                <a class="collapse-item {{ $request->input('type') == 'customer' ? 'active' : '' }}"
                                                    href="{{ action('ContactController@index', ['type' => 'customer']) }}">@lang('report.customer')</a>
                                                {{-- @endif --}}
                                                @endif @if ($contact_group_customer)
                                                    ...
                                                    @if ($contact_list_supplier_map_products)
                                                        <a class="collapse-item {{ $request->segment(1) == 'List_product_bind' && $request->segment(2) == 'product_bind' ? 'active' : '' }}"
                                                            href="{{ action('SupplierMappingController@index') }}">@lang('lang_v1.list_supplier_map_products')</a>
                                                    @endif
                                                    ...
                                                    @if ($contact_add_supplier_products)
                                                        <a class="collapse-item {{ $request->segment(1) == 'product_bind' && $request->segment(2) == 'product_bind' ? 'active' : '' }}"
                                                            href="{{ action('SupplierMappingController@addMapping') }}">@lang('lang_v1.add_supplier_map_products')</a>
                                                    @endif
                                                        ...
                                                        @if (!$property_module && $contact_customer)
                                                            @if (auth()->user()->can('supplier.create') || auth()->user()->can('customer.create'))
                                                                <a class="collapse-item {{ $request->segment(1) == 'contacts' && $request->segment(2) == 'import' ? 'active' : '' }}"
                                                                    href="{{ action('ContactController@getImportContacts') }}">@lang('lang_v1.import_contacts')</a>
                                                            @endcan
                                                                    ...
                                                                    @if ($outstanding_received)
                                                                        @if (auth()->user()->can('payment_received.view'))
                                                                            <a class="collapse-item {{ $request->segment(1) == 'outstanding-received-report' ? 'active' : '' }}"
                                                                                href="{{ action('ContactController@getOutstandingReceivedReport') }}">@lang('lang_v1.outstanding_received')</a>
                                                                        @endif

                                                                        @if ($contact_import_opening_balalnces)
                                                                            <a class="collapse-item {{ $request->segment(1) == 'import-balance' ? 'active' : '' }}"
                                                                                href="{{ action('ContactController@getImportBalance') }}">@lang('lang_v1.import_contacts_balance')</a>
                                                                        @endif
                                                                        ...
                                                                        @endif @endif @if ($contact_supplier)
                                                                            @if ($issue_payment_detail)
                                                                                <a class="collapse-item {{ $request->segment(1) == 'issued-payment-details' ? 'active' : '' }}"
                                                                                    href="{{ action('ContactController@getIssuedPaymentDetails') }}">@lang('lang_v1.issued_payment_details')</a>
                                                                            @endif
                                                                        @endif

                                                                        @if ($contact_returned_cheque_details)
                                                                            <a class="collapse-item {{ $request->segment(1) == 'returned-cheque-details' ? 'active' : '' }}"
                                                                                href="{{ action('ContactController@getReturnedCheques') }}">@lang('sale.returned_cheques_details')</a>
                                                                        @endif
                    ...
                    <div id="products-menu"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            @if (
                                ...
                                @can('product.view')
                                    <a class="collapse-item {{ $request->segment(1) == 'products' && $request->segment(2) == '' ? 'active' : '' }}"
                                        href="{{ action('ProductController@index') }}">@lang('lang_v1.list_products')</a>
                                @endcan
                            @endif
                            ...
                            @if (
                                ...
                                @can('product.create')
                                    <a class="collapse-item {{ $request->segment(1) == 'products' && $request->segment(2) == 'create' ? 'active' : '' }}"
                                        href="{{ action('ProductController@create') }}">@lang('product.add_product')</a>
                                @endcan
                            @endif
                            ...
                            @can('product.view')
                                @if ($product_print_labels)
                                    <a class="collapse-item {{ $request->segment(1) == 'labels' && $request->segment(2) == 'show' ? 'active' : '' }}"
                                        href="{{ action('LabelsController@show') }}">@lang('barcode.print_labels')</a>
                                @endif
                            ...
                            @if (
                                ...
                                @can('product.create')
                                    <a class="collapse-item {{ $request->segment(1) == 'variation-templates' ? 'active' : '' }}"
                                        href="{{ action('VariationTemplateController@index') }}">@lang('product.variations')</a>
                                @endcan
                            @endif
                            ...
                            @if (
                                ...
                                @can('product.create')
                                    <a class="collapse-item {{ $request->segment(1) == 'import-products' ? 'active' : '' }}"
                                        href="{{ action('ImportProductsController@index') }}">@lang('product.import_products')</a>
                                @endcan
                            @endif
                            ...
                            @if (
                                ...
                                @can('product.opening_stock')
                                    <a class="collapse-item {{ $request->segment(1) == 'import-opening-stock' ? 'active' : '' }}"
                                        href="{{ action('ImportOpeningStockController@index') }}">@lang('lang_v1.import_opening_stock')</a>
                                @endcan
                            @endif
                            ...
                            @if (
                                ...
                                @can('product.create')
                                    <a class="collapse-item {{ $request->segment(1) == 'selling-price-group' ? 'active' : '' }}"
                                        href="{{ action('SellingPriceGroupController@index') }}">@lang('lang_v1.selling_price_group')</a>
                                @endcan
                            @endif
                            ...
                            @if (auth()->user()->can('unit.view') || auth()->user()->can('unit.create'))
                                ...
                                @if (
                                    ...
                                    <a class="collapse-item {{ $request->segment(1) == 'units' ? 'active' : '' }}"
                                        href="{{ action('UnitController@index') }}">@lang('unit.units')</a>
                                @endif
                                ...
                                @if (
                                    ...
                                    <a class="collapse-item {{ $request->segment(1) == 'stock_conversion' && $request->segment(2) == 'stock_conversion' ? 'active' : '' }}"
                                        href="{{ action('StockConversionController@index') }}">@lang('Stock Conversion')</a>
                                @endif
                            ...
                            @if (
                                ...
                                @if (auth()->user()->can('category.view') || auth()->user()->can('category.create'))
                                    <a class="collapse-item {{ $request->segment(1) == 'categories' ? 'active' : '' }}"
                                        href="{{ action('CategoryController@index') }}">@lang('category.categories')</a>
                                @endif
                            @endif
                            ...
                            @if (
                                ...
                                @if (auth()->user()->can('brand.view') || auth()->user()->can('brand.create'))
                                    <a class="collapse-item {{ $request->segment(1) == 'brands' ? 'active' : '' }}"
                                        href="{{ action('BrandController@index') }}">@lang('brand.brands')</a>
                                @endif

                                <a class="collapse-item {{ $request->segment(1) == 'warranties' ? 'active active-sub' : '' }}"
                                    href="{{ action('WarrantyController@index') }}">@lang('lang_v1.warranties')</a>
                            @endif

                            @if ($stock_taking_page)
                                <a class="collapse-item {{ $request->segment(1) == 'stock-taking' ? 'active' : '' }}"
                                    href="{{ action('StockTakingController@index') }}">@lang('mpcs::lang.StockTaking_form')</a>
                            @endif
        ...
        <!-- Start Petro Module -->
        @if ($enable_petro_module)
            @can('enable_petro_module.access')
                @include('petro::daily_collection.partials.daily_tab')
            @endcan
                ...
                <li class="nav-item {{ in_array($request->segment(1), ['distribution']) ? 'active active-sub' : '' }}">
                    ...
                    <div id="distribution-menu"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item {{ $request->segment(1) == 'vehicle' && $request->segment(2) == '' ? 'active' : '' }}"
                                href="{{ action('\Modules\Distribution\Http\Controllers\SettingController@index') }}">Settings</a>
                        </div>
                    </div>
                </li>
            @endcan
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            @if ($all_purchase)
                                <a class="collapse-item {{ $request->segment(1) == 'purchases' && $request->segment(2) == null ? 'active' : '' }}"
                                    href="{{ action('PurchaseController@index') }}">@lang('purchase.list_purchase')</a>
                            @endif
                            @if ($add_bulk_purchase)
                                <a class="collapse-item {{ $request->segment(1) == 'purchases' && $request->segment(2) == 'add-purchase-bulk' ? 'active' : '' }}"
                                    href="{{ action('PurchaseController@addPurchaseBulk') }}">@lang('purchase.add_purchase_bulk')</a>
                            @endif
                            @if ($add_purchase)
                                <a class="collapse-item {{ $request->segment(1) == 'purchases' && $request->segment(2) == 'create' ? 'active' : '' }}"
                                    href="{{ action('PurchaseController@create') }}">@lang('purchase.add_purchase')</a>
                            @endif
                            @if ($purchase_return)
                                <a class="collapse-item {{ $request->segment(1) == 'purchase-return' ? 'active' : '' }}"
                                    href="{{ action('PurchaseReturnController@index') }}">@lang('lang_v1.list_purchase_return')</a>
                            @endif
                            @if ($import_purchase)
                                <a class="collapse-item {{ $request->segment(1) == 'import-purchases' ? 'active' : '' }}"
                                    href="{{ action('ImportPurchasesController@index') }}">@lang('lang_v1.import_purchases')</a>
                            @endif
                        </div>
                    </div>
                </li>
                            ...
                            @if ($all_sales)
                                @if (auth()->user()->can('direct_sell.access') || auth()->user()->can('view_own_sell_only'))
                                    <a class="collapse-item {{ $request->segment(1) == 'sales' && $request->segment(2) == null ? 'active' : '' }}"
                                        href="{{ action('SellController@index') }}">@lang('lang_v1.all_sales')</a>
                                @endif
                            @endif
                            <!-- Call superadmin module if defined -->
                                            ...
                                            @endif @if ($customer_order_own_customer == 1 || $customer_order_general_customer == 1)
                                                @if ($list_orders)
                                                    <a class="collapse-item {{ $request->segment(1) == 'sales' && $request->segment(2) == 'customer-orders' ? 'active' : '' }}"
                                                        href="{{ action('SellController@getCustomerOrders') }}">@lang('lang_v1.list_orders')</a>
                                                    @endif @if ($upload_orders)
                                                        <a class="collapse-item {{ $request->segment(1) == 'sales' && $request->segment(2) == 'customer-orders' ? 'active' : '' }}"
                                                            href="{{ action('SellController@getCustomerUploadedOrders') }}">@lang('customer.uploaded_orders')</a>
                                                        @endif @endif @if ($list_sell_return)
                                                            @can('sell.view')
                                                                <a class="collapse-item {{ $request->segment(1) == 'sell-return' && $request->segment(2) == null ? 'active' : '' }}"
                                                                    href="{{ action('SellReturnController@index') }}">@lang('lang_v1.list_sell_return')</a>
                                                            @endcan
                                                            @endif @if ($shipment)
                                                                @can('access_shipping')
                                                                    <a class="collapse-item {{ $request->segment(1) == 'shipments' ? 'active' : '' }}"
                                                                        href="{{ action('SellController@shipments') }}">@lang('lang_v1.shipments')</a>
                                                                @endcan
                                                                @endif @if ($discount)
                                                                    @can('discount.access')
                                                                        <a class="collapse-item {{ $request->segment(1) == 'discount' ? 'active' : '' }}"
                                                                            href="{{ action('DiscountController@index') }}">@lang('lang_v1.discounts')</a>
                                                                    @endcan
                                                                    @endif @if ($subcriptions)
                                                                        @if (auth()->user()->can('direct_sell.access'))
                                                                            <a class="collapse-item {{ $request->segment(1) == 'subscriptions' ? 'active' : '' }}"
                                                                                href="{{ action('SellPosController@listSubscriptions') }}">@lang('lang_v1.subscriptions')</a>
                                                                        @endif
                                                                    @endif
                                                                    @if ($import_sale)
                                                                        <a class="collapse-item {{ $request->segment(1) == 'import-sales' ? 'active' : '' }}"
                                                                            href="{{ action('ImportSalesController@index') }}">@lang('lang_v1.import_sales')</a>
                                                                        @endif @if ($reserved_stock)
                                                                            <a class="collapse-item {{ $request->segment(1) == 'reserved-stocks' ? 'active' : '' }}"
                                                                                href="{{ action('ReservedStocksController@index') }}">@lang('lang_v1.reserved_stocks')</a>
                                                                        @endif
                                                                        @if ($customer_settings)
                                                                            @if ($over_limit_sales)
                                                                                <a class="collapse-item {{ $request->segment(1) == 'sales' && $request->segment(2) == 'over-limit-sales' ? 'active' : '' }}"
                                                                                    href="{{ action('SellController@overLimitSales') }}">@lang('sale.over_limit_sales')</a>
                                                                            @endif
                                                                        @endif
                        </div>
                    </div>
                ...
                <li
                    ...
                    <div id="tpos-menu" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item {{ $request->segment(1) == 'sales' && $request->segment(2) == null ? 'active' : '' }}"
                                href="{{ action('TposController@create') }}">@lang('tpos.add_tpos')</a>

                            <a class="collapse-item {{ $request->segment(1) == 'sales' && $request->segment(2) == null ? 'active' : '' }}"
                                href="{{ action('TposController@index') }}">@lang('tpos.list_tpos')</a>

                            <a class="collapse-item {{ $request->segment(1) == 'sales' && $request->segment(2) == null ? 'active' : '' }}"
                                href="{{ action('TposController@createFpos') }}">@lang('tpos.add_fpos')</a>

                            <a class="collapse-item {{ $request->segment(1) == 'sales' && $request->segment(2) == null ? 'active' : '' }}"
                                href="{{ action('TposController@indexFpos') }}">@lang('tpos.list_fpos')</a>
                        </div>
                    </div>
                </li>
            @endcan
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            @can('purchase.view')
                                <a class="collapse-item {{ $request->segment(1) == 'stock-transfers' && $request->segment(2) == null ? 'active' : '' }}"
                                    href="{{ action('StockTransferController@index') }}">@lang('lang_v1.list_stock_transfers')</a>
                                @endcan @can('purchase.create')
                                <a class="collapse-item {{ $request->segment(1) == 'stock-transfers' && $request->segment(2) == 'create' ? 'active' : '' }}"
                                    href="{{ action('StockTransferController@create') }}">@lang('lang_v1.add_stock_transfer')</a>
                            @endcan {{-- @can('purchase.create') --}}
                            <a class="collapse-item {{ $request->segment(1) == 'stock-transfers-request' && $request->segment(2) == null ? 'active' : '' }}"
                                href="{{ action('StockTransferRequestController@index') }}">@lang('lang_v1.stock_transfer_request')</a>
                            {{-- @endcan --}}
                        </div>
                    </div>
                </li>
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            @can('purchase.view')
                                <a class="collapse-item {{ $request->segment(1) == 'stock-adjustments' && $request->segment(2) == null ? 'active' : '' }}"
                                    href="{{ action('StockAdjustmentController@index') }}">@lang('stock_adjustment.list')</a>
                                @endcan @can('purchase.create')
                                <a class="collapse-item {{ $request->segment(1) == 'stock-adjustments' && $request->segment(2) == 'create' ? 'active' : '' }}"
                                    href="{{ action('StockAdjustmentController@create') }}">@lang('stock_adjustment.add')</a>
                            @endcan
                    ...
                    <div id="expenses-menu" class="collapse" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item {{ $request->segment(1) == 'expenses' && empty($request->segment(2)) ? 'active' : '' }}"
                                href="{{ action('ExpenseController@index') }}">@lang('lang_v1.list_expenses')</a>
                            <a class="collapse-item {{ $request->segment(1) == 'expenses' && $request->segment(2) == 'create' ? 'active' : '' }}"
                                href="{{ action('ExpenseController@create') }}">@lang('messages.add')
                                @lang('expense.expenses')</a>

                            <a class="collapse-item {{ $request->segment(1) == 'expense-categories' ? 'active' : '' }}"
                                href="{{ action('ExpenseCategoryController@index') }}">@lang('expense.expense_categories')</a>

                            <a class="collapse-item {{ $request->segment(1) == 'expense-categories-code' ? 'active' : '' }}"
                                href="{{ action('ExpenseCategoryCodeController@index') }}">@lang('expense.expense_categories_code')</a>
                        </div>
                    </div>
                </li>
            @endif
                        ...
                        <div id="post-dated-cheques-menu"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item {{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'postdated-cheques' ? 'active' : '' }}"
                                    href="{{ action('PostdatedChequeController@create') }}">@lang('account.add_pd_cheques')</a>
                                <a class="collapse-item {{ $request->segment(1) == 'accounting-module' && $request->segment(2) == 'postdated-cheques' ? 'active' : '' }}"
                                    href="{{ action('PostdatedChequeController@index') }}">@lang('account.post_dated_cheque')</a>
                            ...
                            @if ($product_report)
                                @if (auth()->user()->can('stock_report.view') ||
                                    ...
                                    <a class="collapse-item {{ $request->segment(2) == 'product' ? 'active' : '' }}"
                                        href="{{ action('ReportController@getProductReport') }}">@lang('report.product_report')</a>
                                @endif
                            @endif
                            @if ($payment_status_report)
                                @if (auth()->user()->can('purchase_payment_report.view') ||
                                    ...
                                    <a class="collapse-item {{ $request->segment(2) == 'payment-status' ? 'active' : '' }}"
                                        href="{{ action('ReportController@getPaymentStatusReport') }}">@lang('report.payment_status_report')</a>
                                    @endif @endif @if (auth()->user()->can('daily_report.view') ||
                                        ...
                                        <a class="collapse-item {{ $request->segment(2) == 'management' ? 'active' : '' }}"
                                            href="{{ action('ReportController@getManagementReport') }}">@lang('report.management_report')</a>
                                        @endif @if ($verification_report || $report_verification)
                                            <a class="collapse-item {{ $request->segment(2) == 'verification' ? 'active' : '' }}"
                                                href="{{ action('ReportController@getVerificationReport') }}">@lang('report.verification_reports')</a>
                                            @endif @if ($activity_report)
                                                @if (auth()->user()->can('sales_report.view') ||
                                                    ...
                                                    <a class="collapse-item {{ $request->segment(2) == 'activity' ? 'active' : '' }}"
                                                        href="{{ action('ReportController@getActivityReport') }}">@lang('report.activity_report')</a>
                                                @endif
                                            @endif
                                            @can('stock_report.view')
                                                @if (session('business.enable_product_expiry') == 1)
                                                    <a class="collapse-item {{ $request->segment(2) == 'stock-expiry' ? 'active' : '' }}"
                                                        href="{{ action('ReportController@getStockExpiryReport') }}">@lang('report.stock_expiry_report')</a>
                                                @endif
                                            @endcan
                                            @can('stock_report.view')
                                                @if (session('business.enable_lot_number') == 1)
                                                    <a class="collapse-item {{ $request->segment(2) == 'lot-report' ? 'active' : '' }}"
                                                        href="{{ action('ReportController@getLotReport') }}">@lang('lang_v1.lot_report')</a>
                                                @endif
                                            @endcan
                                            @if ($trending_product)
                                                @can('trending_products.view')
                                                    <a class="collapse-item {{ $request->segment(2) == 'trending-products' ? 'active' : '' }}"
                                                        href="{{ action('ReportController@getTrendingProducts') }}">@lang('report.trending_products')</a>
                                                @endcan
                                            @endif
                                            @if ($user_activity)
                                                @can('user_activity.view')
                                                    <a class="collapse-item {{ $request->segment(2) == 'user_activity' ? 'active' : '' }}"
                                                        href="{{ action('ReportController@getUserActivityReport') }}">@lang('report.user_activity')</a>
                                                @endcan
                                            @endif
                                            @if ($report_table)
                                                @can('report_table.view')
                                                    <a class="collapse-item {{ $request->segment(2) == 'table-report' ? 'active' : '' }}"
                                                        href="{{ action('ReportController@getTableReport') }}">@lang('restaurant.table_report')</a>
                                                @endcan
                                            @endif
                                            @if ($report_staff_service)
                                                @can('sales_representative.view')
                                                    <a class="collapse-item {{ $request->segment(2) == 'service-staff-report' ? 'active' : '' }}"
                                                        href="{{ action('ReportController@getServiceStaffReport') }}">@lang('restaurant.service_staff_report')</a>
                                                @endcan
                                            @endif
                                            ...
                                            @if ($contact_report)
                                                @can('contact_report.view')
                                                    <a class="collapse-item {{ $request->segment(2) == 'contact' ? 'active' : '' }}"
                                                        href="{{ action('ReportController@getContactReport') }}">@lang('report.contact_report')</a>
                                                @endcan
                                            @endif
                    ...
                    <div id="customized_reports-menu"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item {{ $request->segment(2) == '129report' ? 'active' : '' }}"
                                href="{{ action('ReportCustomizedController@getProductReportCustomized') }}">@lang('lang_v1.129_reports')</a>
                        </div>
                    </div>
                </li>
                                ...
                                @endif @endif @if ($kitchen)
                                    @can('kitchen.access')
                                        <li
                                            ...
                                            <a class="nav-link"
                                                href="{{ action('Restaurant\KitchenController@index') }}">
                                    ...
                                    @endif @if ($orders)
                                        @can('orders.access')
                                            <li
                                                ...
                                                <a class="nav-link"
                                                    href="{{ action('Restaurant\OrderController@index') }}">
                                                    <i class="fa fa-clone"></i>
                                                                    ...
                                                                    @can('business_settings.access')
                                                                        @if ($business_settings)
                                                                            ...
                                                                            <a class="collapse-item {{ $request->segment(1) == 'business' ? 'active' : '' }}"
                                                                                href="{{ action('BusinessController@getBusinessSettings') }}">
                                                                        ...
                                                                        @if ($business_location)
                                                                            <a class="collapse-item {{ $request->segment(1) == 'business-location' ? 'active' : '' }}"
                                                                                href="{{ action('BusinessLocationController@index') }}">
                                                                                @if ($business_or_entity == 'business')
                                                                        ...
                                                                        <a class="collapse-item {{ $request->segment(1) == 'stores' ? 'active' : '' }}"
                                                                            href="{{ action('StoreController@index') }}">@lang('business.stores_settings')</a>
                                                                        <a class="collapse-item {{ $request->segment(1) == 'stores' ? 'active' : '' }}"
                                                                            href="{{ action('StoreController@fetchUserStorePermissions') }}">@lang('store.store_permissions')</a>
                                                                    @endcan
                                                                    ...
                                                                    @if (auth()->user()->can('tax_rate.view') || auth()->user()->can('tax_rate.create'))
                                                                        @if ($tax_rates)
                                                                            <a class="collapse-item {{ $request->segment(1) == 'tax-rates' ? 'active' : '' }}"
                                                                                href="{{ action('TaxRateController@index') }}">@lang('tax_rate.tax_rates')</a>
                                                                        @endif
                                                                    @endif
                                                                    @if ($customer_settings)
                                                                        ...
                                                                        @can('business_settings.access')
                                                                            <a class="collapse-item {{ $request->segment(1) == 'modules' && $request->segment(2) == 'tables' ? 'active' : '' }}"
                                                                                href="{{ action('Restaurant\TableController@index') }}">@lang('restaurant.tables')</a>
                                                                        @endcan
                                                                        @if ($expenses)
                                                                            @if (auth()->user()->can('product.view') || auth()->user()->can('product.create'))
                                                                                <a class="collapse-item {{ $request->segment(1) == 'modules' && $request->segment(2) == 'modifiers' ? 'active' : '' }}"
                                                                                    href="{{ action('Restaurant\ModifierSetsController@index') }}">@lang('restaurant.modifiers')</a>
                                                                            @endif
                                                                        @endif
                                                                    @endif
                                                                    @if (!$property_module)
                                                                        <a class="collapse-item {{ $request->segment(1) == 'types-of-service' ? 'active active-sub' : '' }}"
                                                                            href="{{ action('TypesOfServiceController@index') }}">@lang('lang_v1.types_of_service')</a>
                                                                    @endif
                                                                @endif
                                                                @if (Module::has('Superadmin'))
                                                                @endif
                                                                    ...
                                                                    <div class="bg-white py-2 collapse-inner rounded">
                                                                        ...
                                                                        @can('user_group.view')
                                                                            <a class="collapse-item {{ $request->segment(1) == 'user-groups' ? 'active active-sub' : '' }}"
                                                                                href="{{ action('UserGroupController@index') }}">@lang('user_group.user_groups')</a>
                                                                        @endcan
                                                                        @can('user.view')
                                                                        ...
                                                                        @can('roles.view')
                                                                            <a class="collapse-item {{ $request->segment(1) == 'roles' ? 'active active-sub' : '' }}"
                                                                                href="{{ action('RoleController@index') }}">@lang('user.roles')</a>
                                                                        @endcan
                                                                    ...
                                                                    <div class="bg-white py-2 collapse-inner rounded">
                                                                        ...
                                                                        @if ($cheque_dashboard)
                                                                            <a class="collapse-item {{ $request->segment(1) == 'cheque-dashboard' && $request->segment(2) == '' ? 'active' : '' }}"
                                                                                href="{{ url('chequerDashboard') }}">Chequer
                                                                                Dashboard</a>
                                                                        @endif
